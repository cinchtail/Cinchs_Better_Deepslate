...
public class ModBlockSetType {
    ...
    public static final BlockSetType POLISHED_DEEPSLATE = register(new BlockSetType("polished_deepslate", true, true,
            false,BlockSetType.PressurePlateSensitivity.MOBS, SoundType.POLISHED_DEEPSLATE, SoundEvents.IRON_DOOR_CLOSE,
            SoundEvents.IRON_DOOR_OPEN, SoundEvents.IRON_TRAPDOOR_CLOSE, SoundEvents.IRON_TRAPDOOR_OPEN, SoundEvents.STONE_PRESSURE_PLATE_CLICK_OFF,
